...
export default function NavbarComponent() {
    ...
    return (
        <div className="flex justify-between items-center text-white px-3 max-w-[1100px] mx-auto pt-4 absolute top-0 right-0 left-0">
            {isLoggedIn ? <Link to='/dashboard'><div className="flex items-center"><img src={logo} className="w-[40px] "/><h1 className="text-2xl">Purr<span className="font-semibold">Money</span></h1></div></Link> : <Link to='/'><div className="flex items-center"><img src={logo} className="w-[40px] "/><h1 className="text-2xl">Purr<span className="font-semibold">Money</span></h1></div></Link>}
