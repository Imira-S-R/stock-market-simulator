    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white flex items-center px-4">
            <div className="max-w-[1100px] mx-auto text-center">
                ...
                <button onClick={() => { checkAuth() }} className="mt-10 px-8 py-4 bg-green-500 hover:bg-green-400 text-black font-semibold rounded-lg transition duration-200 shadow-lg hover:shadow-green-500/30">
                    Get Started
                </button>
